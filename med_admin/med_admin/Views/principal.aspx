<%@ Page Title="" Language="C#" MasterPageFile="~/Views/med_admin.Master" AutoEventWireup="true" CodeBehind="principal.aspx.cs" Inherits="med_admin.Views.principal" %>
                        ...
                        <div class="card-box widget-user">
                            <div>
                                ...
                                <div class="wid-u-info">
                                    ...
                                    <a href="cad-Mediacao.html"> <span class="label label-warning">Abrir</span></a>
                                </div>
                            </div>
                        </div>
                        </div>
                            ...
                            <div>
                                ...
                                <div class="wid-u-info">
                                    ...
                                    <div class="collapse" id="collapseExample">
                                        ...
                                        <br><br><br>
                                        <center>
                                        <button class="btn btn-success btn-rounded">Realizar Agendamento</button>
                                        </center>
